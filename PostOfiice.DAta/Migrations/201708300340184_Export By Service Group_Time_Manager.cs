namespace PostOfiice.DAta.Migrations
{
    ...
    public partial class ExportByServiceGroup_Time_Manager : DbMigration
    {
        public override void Up()
        {
            CreateStoredProcedure(
                "Export_By_Service_Group_And_Time_Manager",
                p => new
                {
                    fromDate = p.String(),
                    toDate = p.String(),
        ...
        {
            DropStoredProcedure("Export_By_Service_Group_And_Time_Manager");
        }
    }
}
