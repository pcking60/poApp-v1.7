namespace PostOfiice.DAta.Migrations
{
    ...
    public partial class Export_service_group_by_time_district : DbMigration
    {
        public override void Up()
        {
            CreateStoredProcedure(
                "Export_By_Service_Group_And_Time_District",
                p => new
                {
                    fromDate = p.String(),
                    toDate = p.String(),
	            ...
	            where ps.Name like N'Sản lượng%' and ts.Status=1 and sg.MainServiceGroupId=@mainGroup and CAST( ts.TransactionDate as date) between CAST(@fromDate as date) and CAST(@toDate as date) and d.ID=@districtId
        ...
        {
            DropStoredProcedure("Export_By_Service_Group_And_Time_District");
        }
    }
}
